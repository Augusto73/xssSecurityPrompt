...
-----------
LIVELLO 1: 1-xss-screening-prompt.txt
LIVELLO 2: 2-xss-audit-prompt.txt
LIVELLO 3: 3-xss-check-list-manuale.txt
...
STEP 1: LIVELLO 1 (screening veloce)
  ...
  2. Incolla 1-xss-screening-prompt.txt
  3. Incolla owasp-encoding.js
  4. Incolla JSP
  5. inserisci il segunte prompt: Analizza per primo il file: 1-xss-screening-prompt.txt allegato: ci sono tutte le istruzioni
  6. Invia
...
STEP 2: LIVELLO 2 (audit dettagliato)
  ...
  2. Incolla 2-xss-audit-prompt.txt
  3. Incolla owasp-encoding.js
  4. Incolla JSP
  5. inserisci il segunte prompt: Analizza per primo il file: 2-xss-audit-prompt.txt allegato: ci sono tutte le istruzioni
  6. Invia
  7. Controlla report (✓/✗)
